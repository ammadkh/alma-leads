...
export default function HomePage() {
  const [hideInfoSection, setHideInfoSection] = useState(false);

  return (
    <div className="min-h-screen bg-gray-50">
      {/* Hero Section */}
      <div className="bg-[#d9dea5] relative overflow-hidden min-h-[400px] flex items-center">
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 w-full relative">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <LeadForm onSuccess={setHideInfoSection} />
      </div>
    </div>
  );
}
